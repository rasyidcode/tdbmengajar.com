        ...
        <div class="container py-md-5">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="news-card">
                        <div class="thumb">
                            <img src="{{ asset('images/gallery_4.jpeg') }}" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="news-detail">
                            ...
                            <div class="news-detail-content p-2">
                                <a class="h4" href="{{ route('get_article', 1) }}">Lorem ipsum dolor vs bla bla bla</a>
        ...
        <div id="elementary" class="container-fluid sd-content scroll-spy2">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8 offset-md-4 py-5 pr-lg-5"> <!--  -->
                    ...
                    <a href="{{ route('get_elementary') }}" class="btn btn-primary btn-learn-more text-uppercase">
        ...
        <div id="kindergarden" class="container-fluid tk-content scroll-spy2">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8 py-5 pl-lg-5">
                    ...
                    <a href="{{ route('get_kindergarden') }}" class="btn btn-primary btn-learn-more text-uppercase">
                        Pelajari Selengkapnya
                    </a>
                </div>
            </div>
                    ...
                    <div id="galleryIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('images/gallery_11.jpeg') }}" alt="Student">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('images/gallery_21.jpeg') }}" alt="Student">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('images/gallery_17.jpeg') }}" alt="Student">
                                </div>
                            </div>
                        </div>
                    </div>
